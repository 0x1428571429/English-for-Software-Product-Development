...
- Can you check if it's backend?

### AI帮忙分析
> B: Let me paste the error into AI.
> A: I already tried. AI suggested checking the reducer, but I don't think that's it.

- I already tried AI — AI 试过了
- AI suggested X but I'm not sure — AI 说是 X 但我不确定
- Let's not rely on AI for this one — 这个 AI 靠不住
